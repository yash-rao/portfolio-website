...
export default function Work() {
  const workExperiences = [
    ...
    },
    {
      ...
      tags: [
        "Generative AI", "Natural Language Processing (NLP)", "Text Generation",
        "Text Summarization", "GPT-3 Fine-Tuning", "Machine Learning Model Evaluation",
        "Performance Metrics (BLEU, ROUGE)", "Model Optimization", "Hugging Face Library",
        "Prototype Development", "Research Presentation", "AI Research Symposium",
    ...
    },
    {
      ...
      tags: [
        "Spring Boot", "SSO", "Data Analytics", "XML", "SailPoint IdentityNow", "Git",
        "Powershell", "Apache Velocity", "Java", "Postman", "Azure Active Directory", "Active Directory"
      ],
    ...
    <section id="work" className="work-section">
      ...
      <div className="work-container">
        <div className="work-tabs tabs">
          <span className="work-highlighter-track"></span>
